...
public class InBill2 extends javax.swing.JDialog {
    ...
    public void setForm() {
        ...
        for (HoaDonChiTiet itemp : list) {
            ...
            setLabel(lblTenKH, "Tên KH: " + itemp.getTenKH(), font, 35, 150, 200, 20);
            setLabel(lblMaKH, "Mã KH: " + itemp.getMaKH(), font, 865, 150, 200, 20);
